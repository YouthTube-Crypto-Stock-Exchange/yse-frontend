            ...
            <Container>
                <Row className="py-4">
                    <Col className="d-flex flex-column align-items-center">
                        <Card border="dark" className='bg-dark text-light px-2 pt-2 text-center w-50'>
                            <Card.Title>
                                <h2> Ether : {ether} </h2>
                            </Card.Title>
                        </Card>
                    ...
                    <Col className="d-flex flex-column align-items-center">
                        <Card border="dark" className='bg-dark text-light px-2 pt-2 text-center w-75'>
                            <Card.Title>
                                ...
                                <Table hover className="text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="col-1"> Number of Shares </th>
                                            <th className="col-1"> Invested Price </th>
                                            <th className="col-1"> Average Price </th>
                                            <th className="col-1"> Current Price </th>
                                    ...
                                    <tbody >
                                        {holdings.map((holding) => {
                                            ...
                                            return(<tr>
                                                ...
                                                <td>{holding.investedPrice}</td>
                                                <td>{holding.avgPrice}</td>
                                                <td>{holding.currentPrice}</td>
                                                <td className={textColor}>{deltaSign}{holding.pnl}</td>
                                                <td className={textColor}>{deltaSign}{holding.change}%</td>
                                            </tr>);
                                        })}
                                    </tbody>
                                </Table>
